...
with col1:
    st.image("assets/3312.jpg", width=200, caption="Estudiante", output_format="JPEG")

# Columna derecha: Información del estudiante
with col2:
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">David Lopera Giraldo</h3>', unsafe_allow_html=True)
